...
- 新增真实 SQLite 全迁移、Miniflare D1/R2、Wrangler dry-run、Git/worktree race 与 publisher sealed-byte 回归。该条仅记录本地源码能力；preview/production 在按序应用 `0008`/`0009`、安装 secret、部署并完成 live verification 前仍是 legacy v10 状态。
