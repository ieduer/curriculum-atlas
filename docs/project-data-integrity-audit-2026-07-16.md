...
> 2026-07-22 后续订正：教育部原件题名核对确认 `moe-2011-12` 为“义务教育初中科学课程标准（2011年版）”；原单列的 `ictr-f6754fe2f491` 是同版不同扫描件，现作为非发布 variant 归入同一作品。所以下文 196 文档与 86/11,847 队列数字只描述 2026-07-16 的不可变审计快照；订正后的本地候选为 195 个作品身份、85/11,759 名义 OCR 队列与 84/11,691 唯一 OCR 实体，两份 PDF 均保留。
