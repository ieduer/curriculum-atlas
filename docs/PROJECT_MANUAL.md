...
v19/v46 同一發布候選的真實 preview runtime 收據為：桌面 1440×1000，ready 853.2 ms、draw p95 4 ms、long task 1／68 ms；手機 390×844，ready 1437.2 ms、draw p95 2.5 ms、long task 1／57 ms。兩端均為單一 Canvas、10 個星圖內年代顯隱階段、左側默認折疊、零橫向溢出。正式域另在首頁仍載入至 1991 年時立即點擊歷史鏈與「社会科合科编组」：立即及 3.8 秒後均保持全部 58 個年份、只顯示思政／歷史／地理，證明學科焦點不會再被 1902→2022 入場動畫覆寫；事件第二次點擊退回歷史百年鏈，學科鏈第二次點擊恢復進入前的 11 學科狀態。
