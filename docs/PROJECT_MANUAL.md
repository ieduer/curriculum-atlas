...
55 個概念族合計 118 個受控概念、1,171 個 1902–2022 episode memberships。12 科名稱族都必須同時有 2001 年前 OCR 節點和 2001 年後教育部編目節點；新增的 36 條細粒度族由 32 冊、3,044 頁來源哈希一致且全頁完成的課標 OCR 生成 97 個 2001–2022 版本觀測。歷史與社會目前止於 2011；勞動只有 2022 單版本，兩者在 `coverage_contract` 明示，不假造缺失年份。編目標題和 OCR 候選均不代替正文引文證據。所有數字由 builder 生成，不手填進前端。
