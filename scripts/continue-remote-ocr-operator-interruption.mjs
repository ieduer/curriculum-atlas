...
function usage() {
  return [
    ...
    '',
    'All incident identity, filesystem, authority, and hash anchors are compiled into a source-pinned strict profile;',
    'the command rejects caller-supplied incident proofs. Execution remains gated by the reviewed sealed Linux',
    'runtime checks and two byte-identical, mutation-free live dry-runs against the frozen production target.',
