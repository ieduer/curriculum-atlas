...
管理员审核、举报处置、AI 故障最小化视图、只读资料清单与审计边界见 [docs/admin-control-plane.md](docs/admin-control-plane.md)。
